    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          SizedBox( height: 20,),
          MainCard(
            mainCardImage: 'assets/logo/one.png',
          ),
          Column(
            children: [
              Row(
                ...
                children: [
                  MainGridViewHome(
                      titleCard: 'Quran',
                      bgImage: 'assets/logo/two.png',
                      avatarImage: 'assets/logo/two.png',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => QuranChapterList()),
                        );
                      }),
                  MainGridViewHome(
                    titleCard: 'Adan',
                    bgImage: 'assets/logo/logo.png',
                    avatarImage: 'assets/logo/logo.png',
                    onTap: () {},
                  ),
                ],
              ),
              Row(
                ...
                children: [
                  MainGridViewHome(
                      titleCard: 'Dikr & Dua',
                      bgImage: 'assets/logo/three.png',
                      avatarImage: 'assets/logo/three.png',
                      onTap: () {}),
